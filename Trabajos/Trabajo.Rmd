...
abalone.lm7 <- lm(Ring~.-Length -Viscera_weight -Sex + Shell_weight*Diameter +  I(Shucked_weight^2) + I(Whole_weight^2), data=abalone.df)
summary(abalone.lm7)
```
...
# Fórmula original: Ring~.-Length -Viscera_weight -Sex + Shell_weight*Diameter +        I(Shucked_weight^2
...
### 1.4.4. Comparación de algoritmos
